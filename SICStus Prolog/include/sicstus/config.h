...
#define SP_OS_DATA_PLATFORM_NAME_STRING "win32nt"
#define SP_JIT_ABI_STRING "winx64"
...
#define SP_FLI_APPLY_ASM_GENERIC 1
...
/* System information */
#define SYSTEM_NAME "x86_64-win32-nt-4"
...
#define RTKERNEL_BASENAME_WITH_DSO_SUFFIX_STRING "sprt4-6-0.dll"
...
/* Something like "libsprt-4-1-2-instance-XX.so". Must contain exactly
   ...
   literal string) */
#define RTKERNEL_INSTANCE_TEMPLATE_STRING "sprt4-6-0-instance-XX"
...
/* __int128 GCC/CLANG */
#define SP_SIZEOF___INT128 0
/* __int128_t GCC/CLANG */
#define SP_SIZEOF___INT128_T 0
...
#define HAVE_PTHREAD_TESTCANCEL 0
...
#define SP_AVOID_PTHREAD_CANCEL 0
